...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const CONC_DILUTE_REACTIONS = {
    ...
    'h2so4_dil+fe': {
      ...
      synthesis: { name: 'Sắt(II) Sunfat FeSO₄ + Khí H₂', icon: '⚗️', category: 'Kim loại + Axit Loãng' },
    ...
    'nh3_conc+hcl': {
      ...
      synthesis: { name: 'NH₄Cl — Thí Nghiệm Hai Bình Khói Trắng', icon: '☁️', category: 'Axit + Bazơ Khí' },
      particles: [{ type: 'smoke', color: 'rgba(255,255,255,0.85)', count: 70 }],
      colorChange: { end: 'rgba(248,250,252,0.5)' },
      description: 'NH₃(k) + HCl(k) tác dụng ngay trên bề mặt lọ → tinh thể NH₄Cl siêu nhỏ lơ lửng = KHÓI TRẮNG. Thí nghiệm nhận biết axit/bazơ đẹp nhất.',
    ...
    'naoh_conc+al': {
      ...
      synthesis: { name: 'Natri Aluminat NaAlO₂ + Khí H₂', icon: '⚗️', category: 'Kim loại Lưỡng Tính + Bazơ' },
      ...
      observation: '⬆️ Bọt H₂ dữ dội! Nhôm biến mất dần. Kim loại lưỡng tính — tan trong cả axit lẫn bazơ!',
    ...
    'koh_conc+al': {
      ...
      type: 'metal-base', effect: 'bubbles-intense',
      synthesis: { name: 'Kali Aluminat KAlO₂ + Khí H₂', icon: '⚗️', category: 'Kim loại Lưỡng Tính + Bazơ' },
      particles: [{ type: 'bubble', color: '#e0f2fe', count: 60 }],
    ...
    'ch3cooh_glacial+naoh': {
      ...
      synthesis: { name: 'Natri Axetat CH₃COONa (muối giấm đậm đặc)', icon: '🫙', category: 'Trung hòa Axit Băng' },
    ...
    'ch3cooh_glacial+na_metal': {
      ...
      synthesis: { name: 'CH₃COONa (muối giấm) + H₂ bùng cháy', icon: '🫙', category: 'Axit Băng + Kim loại' },
      ...
      observation: '🔥 Na tan nhanh trong axit băng! H₂ bốc cháy ngọn lửa vàng cam!',
